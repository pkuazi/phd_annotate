...
def remove_infs(array):
    ...
    return array
def main():
    rasterfile = '/home/zjh/hz_zjh/gf1c_pms_e120.0_n30.2_20210326_l1a1021729833_area.tif'
    ...
    NDVI=(NIR -R)/(NIR +R)
    dst_file = '/home/zjh/tmp/gf1c_ndvi.tif'
    array_to_tiff(NDVI, proj, gt, 1, dst_file)
